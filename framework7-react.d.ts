declare module "framework7-react" {
    ...
    type Colors = 'red' | 'green' | 'blue' | 'pink' | 'yellow' | 'orange' | 'gray' | 'white' | 'black';
    ...
    export interface F7Props extends F7ColorProps {
        slot?: string;
        className?: string;
        [key: string]: any;
    }
    ...
    namespace Fab {
        export interface Props extends F7Props {
            ...
            onClick?(event: React.FormEvent<HTMLDivElement | HTMLAnchorElement>)
        }
    }
    ...
    namespace Input {
        export interface Props extends F7Props {
            ...
            onInputClear?(event: React.FormEvent<HTMLInputElement>);

            onTextareaResize?(event: React.FormEvent<HTMLInputElement>)

            onInputEmpty?(event: React.FormEvent<HTMLInputElement>)

            onInputNotempty?(event: React.FormEvent<HTMLInputElement>)
        }
    }
    ...
    namespace ListItem {
        export interface Props extends F7Props {
            ...
            /* Form inputs specific properties */
            inlineLabel	?:boolean;
            itemInput	?:boolean;
            itemInputWithInfo	?:boolean;

            /* Swipeout specific properties */
            swipeout?: boolean;
            ...
            /* Smart Select specific properties */
            smartSelect?: boolean;
            smartSelectParams?: {};

            /* Checkboxes & Radios specific properties */
            checkbox	?: boolean;
            radio	?: boolean;
            checked	?: boolean;
            ...
            /* navigation/router related properties */
            link	?: boolean | string;
            href	?: string | boolean;
            view	?: string;
            external	?: boolean;
            ...
            onClick?(event: any);
            onChange?(event: any);
            onSwipeout?(event: any);
            onSwipeoutOpen?(event: any);
            onSwipeoutOpened?(event: any);
            onSwipeoutClose?(event: any);
            onSwipeoutClosed?(event: any);
            onSwipeoutDelete?(event: any);
            onSwipeoutDeleted?(event: any);
            onAccordionOpen?(event: any);
            onAccordionOpened?(event: any);
            onAccordionClose?(event: any);
            onAccordionClosed?(event: any);
